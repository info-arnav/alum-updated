      ...
      {loading ? (
        ...
        <>
          <div className="md:grid md:grid-cols-5 md:divide-x divide-y gap-2">
            <div
              className="recruitment-grid gap-2.5 mb-[40px] col-span-2 overflow-x-scroll md:overflow-x-hidden max-w-screen md:overflow-y-scroll md:h-[calc(100vh-80px)] md:min-h-[400px] md:block flex flex-row whitespace-nowrap md:bg-white bg-[#dcdcdc]"
