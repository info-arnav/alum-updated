...
export default function DataFetch({ email }) {
  ...
  const ReadHandler = (e)=>{
    Set_expanded_data((prev)=>{return e});
  }
      ...
      {loading ? (
        ...
        <div className="grid grid-cols-5  divide-x">
          <div className="recruitment-grid mb-[40px] col-span-2 overflow-y-scroll h-[97vh] ">
            {data.map((e) => {
              return (
                <div onClick={()=>ReadHandler(e)} key={e._id} className="recruitment-box">
                  ...
                  <div className="recruitment-box-body">
                    ...
                    <div className=" text-center">
                      <svg className="inline m-1" width="16" height="16" viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M1 9.9999V6.43989C1 2.01989 4.13 0.209895 7.96 2.4199L11.05 4.1999L14.14 5.9799C17.97 8.1899 17.97 11.8099 14.14 14.0199L11.05 15.7999L7.96 17.5799C4.13 19.7899 1 17.9799 1 13.5599V9.9999Z" stroke="#5B5B5B" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                      <p className="inline">Start Date</p>
                      <p>{e.start_date || "No data"}</p>
                    </div>
                    <div className=" text-center">
                      <svg className="inline m-1" width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8 1.99988V4.99988M16 1.99988V4.99988M3.5 9.08988H20.5M21 8.49988V16.9999C21 19.9999 19.5 21.9999 16 21.9999H8C4.5 21.9999 3 19.9999 3 16.9999V8.49988C3 5.49988 4.5 3.49988 8 3.49988H16C19.5 3.49988 21 5.49988 21 8.49988Z" stroke="#5B5B5B" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M15.695 13.6999H15.704M15.695 16.6999H15.704M11.995 13.6999H12.005M11.995 16.6999H12.005M8.29401 13.6999H8.30401M8.29401 16.6999H8.30401" stroke="#5B5B5B" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                      <p className="inline">Duration</p>
                      <p>{e.duration || "No Duration Provided"}</p>
                    </div>
                    <div className="text-center">
                      <svg className="inline m-1" width="22" height="18" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_26_186)">
<path d="M16 18.4999H6C3 18.4999 1 16.9999 1 13.4999V6.49988C1 2.99988 3 1.49988 6 1.49988H16C19 1.49988 21 2.99988 21 6.49988V13.4999C21 16.9999 19 18.4999 16 18.4999Z" stroke="#5B5B5B" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M18 4.99988H15M7 14.9999H4M11 12.9999C11.7956 12.9999 12.5587 12.6838 13.1213 12.1212C13.6839 11.5586 14 10.7955 14 9.99988C14 9.20423 13.6839 8.44117 13.1213 7.87856C12.5587 7.31595 11.7956 6.99988 11 6.99988C10.2044 6.99988 9.44129 7.31595 8.87868 7.87856C8.31607 8.44117 8 9.20423 8 9.99988C8 10.7955 8.31607 11.5586 8.87868 12.1212C9.44129 12.6838 10.2044 12.9999 11 12.9999Z" stroke="#5B5B5B" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
</g>
<defs>
...
<path d="M10 4.99988V9.99988M18.75 10.2499C18.75 15.0799 14.83 18.9999 10 18.9999C5.17 18.9999 1.25 15.0799 1.25 10.2499C1.25 5.41988 5.17 1.49988 10 1.49988C14.83 1.49988 18.75 5.41988 18.75 10.2499Z" stroke="#5B5B5B" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
