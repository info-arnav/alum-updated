    ...
    <div className="main-container">
      <div className="container">
        ...
        <p className="content">
          ...
          <br></br>
          <br></br>
          Our goal is to help alumni stay connected to their alma mater, provide
          students with access to valuable resources and mentorship, and allow
          the university to maintain a strong and supportive network.
          <br></br>
          <br></br>
...
<ul>
    ...
    <li>User Activity Data: Log-in frequency, time spent on the platform, content engagement, and interaction with other users</li>
          ...
          return <Dropdown title={e[0]} content={e[1]} key={e[0]}></Dropdown>;
        })}
      </div>
    </div>
  );
